<template>
  <div id="home">
    <v-toolbar color="teal accent-2">
      ...
      <v-select :items="categories"v-model="selectedCategory"label="Filter Category"multiple chips autocomplete></v-select>
    </v-toolbar>
  ...
  data () {
    return {
      ...
      categories: ['Arts & Entertainment', 'Automotive & Vehicle', 'Beauty & Fitness', 'Business & Industrial',
        'Computers & Technology', 'Education and Employment', 'Food & Drink', 'Home & Garden', 'Law & Government',
        'Leisure & Hobbies', 'News', 'Science', 'Shopping', 'Sports', 'Sexuality', 'Philosophy', 'Travel', 'Video Games'
      ],
      selectedCategory:''
    };
  },
